...
import FilterMenu from "../../../component/dashboard/tools/FilterMenu";
import DatePicker from "../../../component/dashboard/tools/DatePicker";

import file_data from "./dummyfile";
...
const PolicyList = () => {
  ...
  const SORT_BY_OPTIONS = [
    ...
    { value: "NOTRENEW", label: "NOT-RENEW" },
  ];

  const [FilterKey, setFilterKey] = useState("RENEWAL");
  ...
  }, [dispatch, Auth, FilterKey, FilterStartDate, FilterEndDate]);

  return (
    <>
      <Page
        title={`Report ${FilterKey}`}
